...
</p>`;o=htmlToElement(s)}else{const n=e[t.dataset.src.replace(/\/$/g,"").replace(s,"")];if(n){const e=n.tags.map(e=>`#${e}`).join(" "),t=`<div class="popover">
            <h3 class="popoverTitle" data-title=${n.title}>${n.title}</h3>
            <p class="linkTag" data-tag=${e}>${e}</p>
            <p>${removeMarkdown(n.content).split(" ",50).join(" ")}...</p>
